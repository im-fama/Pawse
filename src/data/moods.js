...
//
// `id` is what gets written to Supabase (mood_logs.mood). Keep these
// stable once you ship - changing an id orphans old log rows, since
// historical rows would no longer match any mood in this list.
//
