...
import { logMood } from "../logic/moodLogs";
import "./MoodCarouselScreen.css";

export default function MoodCarouselScreen({ daysApart, userId, onMoodLogged }) {
  ...
  return (
    ...
    >
      <div className="pawse-inner-card">
